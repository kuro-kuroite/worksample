...
ここで重要なのは、Railsをきちんと理解するために必要な事前知識を調べて、見出しレベルに落とし込むことです。  
...
ここで重要なのは、誤差逆伝播法をきちんと理解するために必要な事前知識を調べて、見出しレベルに落とし込むことです。  
初心者の人でも分かるようなテキストにすることを心がけて作成してください。  
...
見出しを作成することができたら、その次はワークサンプル担当者からのレビューがあり、そして見出しに肉付けを行います。  
今回は、`先程作成した見出しではなく`、ワークサンプル担当者が指定するテーマに沿って見出しを作成し、肉付けをして完成させてください。  
...
- [v] `1_create_heading.md`に見出しを記述した
- [v] `2_fleshed_out_headline.md`に見出しに肉付けを行った文章を記述した
- [v] `3_improve_sentences.md`に修正文を記述して、プルリクエストを送信した
- [v] `4_question_answer.md`に回答を記述した
